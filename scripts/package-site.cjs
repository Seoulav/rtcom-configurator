...
for(const file of ['index.html','src/catalog.js','src/core.js','src/app.js','src/product-catalog.js','src/search-synonyms.js','src/product-search.js','src/catalog-validator.js','src/library.js','src/portal.js','src/styles.css','output/design/assets/xdm.jpg',...rearAssets,'output/design/assets/spx.jpg','output/design/assets/vdm.jpg',...cardAssets,...libraryAssets,'docs/evidence/RTCOM_MATRIX_EVIDENCE_AND_GAPS.md']){
