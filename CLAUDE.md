...
- 구성기 단일 화면 전환은 `0.7.0`, Analog Way 방식 화면 개편은 `0.8.0`, 전송기 자동 연동은 `0.9.0`, HDMI 카드 PSE 쌍 연장은 `0.10.0`, SPX 매뉴얼 사진 슬롯은 `0.11.0`, VDM-256X 추가는 `0.12.0`, VDM 매뉴얼 후면 도면 슬롯은 `0.13.0`, 휴대폰 슬롯 겹침·뒤로가기 수정은 `0.14.0`, VDM 전면 도면은 `0.15.0`으로 기록했습니다. 다음 기능 묶음은 `0.16.0`을 목표로 하며, 실제 병합 전에는 검증된 canonical main commit을 확인합니다.
