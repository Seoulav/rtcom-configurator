  ...
  (()=>{
    ...
    const cardTips={
      ...
      'XDM-HOS100':'HDMI 디스플레이 4채널 출력용입니다.','XDM-DPOS100':'DisplayPort 디스플레이 4채널 출력용입니다.','XDM-COS100':'HDBaseT 3.0 기반 원격 출력 4채널용입니다.','XDM-FOS100':'광 전송 기반의 원거리 출력 4채널용입니다.','XDM-SOS100':'12G-SDI 방송 신호 4채널 출력용입니다.','XDM-WOS100':'4개 레이어를 조합해 월 프로세서처럼 화면 연출에 활용할 수 있습니다.'
    };
    ...
    function cardsViewV3(){
      ...
      const wosTip=selectedSlot.dir==='output'?'<div class="rt-pro-tip"><span>활용 TIP</span><div><strong>XDM-WOS100 · 4 LAYER</strong><p>4개 레이어를 조합해 월 프로세서처럼 화면을 연출할 수 있습니다.</p></div></div>':'';
