...
**현재 버전: 0.11** · XDM·SPX·VDM 매트릭스의 프레임과 카드 슬롯을 구성하는 내부 검토용 도구입니다.
...
- VDM 8종은 매뉴얼 KV07 기준 실제 슬롯 수(8X 2·2 ~ 180X 45·45)로 구성하고, VDM-288X(특수 상황실용 커스텀)는 논리 슬롯으로 둡니다.
...
- `scripts/tools/extract_vdm_assets.py`: VDM 매뉴얼 KV07과 VDM-48X 사진에서 VDM 판넬·블랭크·프레임 사진 생성.
